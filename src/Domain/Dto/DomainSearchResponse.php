...
final class DomainSearchResponse
{
    /**
     * @param RestError[] $errors
     */
    public function __construct(
        private readonly ?PageDomainModel $data,
    ...
    public static function fromArray(array $payload): self
    {
        ...
        if (isset($payload['data']) && is_array($payload['data'])) {
            $data = PageDomainModel::fromArray($payload['data']);
        }
    ...
    public function getData(): ?PageDomainModel
    {
        return $this->data;
    }
