...
final class DomainTypologyResponse
{
	/**
	 * @param RestError[] $errors
	 */
	public function __construct(
		private readonly ?DomainTypologyModel $data,
	...
	public static function fromArray(array $payload): self
	{
		...
		if (array_key_exists('data', $payload)) {
			$data = DomainTypologyModel::fromArray($payload['data']);
		}
	...
	public function getData(): ?DomainTypologyModel
	{
		return $this->data;
	}
