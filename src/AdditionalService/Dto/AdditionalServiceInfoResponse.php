...
final class AdditionalServiceInfoResponse
{
    /**
     * @param RestError[] $errors
     */
    public function __construct(
        private readonly ?AdditionalServiceModel $data,
    ...
    public static function fromArray(array $payload): self
    {
        ...
        if (isset($payload['data']) && is_array($payload['data'])) {
            $data = AdditionalServiceModel::fromArray($payload['data']);
        }
    ...
    public function getData(): ?AdditionalServiceModel
    {
        return $this->data;
    }
