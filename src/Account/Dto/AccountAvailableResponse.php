...
final class AccountAvailableResponse
{
    /**
     * @param RestError[] $errors
     */
    public function __construct(
        private readonly ?AccountAvailableModel $data,
    ...
    public static function fromArray(array $payload): self
    {
        ...
        if (isset($payload['data']) && is_array($payload['data'])) {
            $data = AccountAvailableModel::fromArray($payload['data']);
        }
    ...
    public function getData(): ?AccountAvailableModel
    {
        return $this->data;
    }
